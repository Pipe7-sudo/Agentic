  ...
  return (
    <section id="cta" className="py-32 text-center relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <h2 className="font-['Outfit'] text-[clamp(32px,5vw,60px)] font-black tracking-[-2px] mb-5">
          Your AI workforce<br />starts <span className="gradient-text">tomorrow</span>.
        </h2>
        <p className="text-[17px] text-slate-400 max-w-[480px] mx-auto leading-[1.65] mb-10">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap">
          <a href="mailto:hello@workforceai.africa" id="cta-primary-btn" className="px-8 py-3.5 rounded-[10px] text-[15px] font-semibold text-white gradient-bg shadow-[0_4px_24px_rgba(99,102,241,0.35)] hover:-translate-y-px hover:shadow-[0_6px_32px_rgba(99,102,241,0.5)] transition-all no-underline">
            Book a Demo Call →
          </a>
          <a href="mailto:hello@workforceai.africa" id="cta-secondary-btn" className="px-8 py-3.5 rounded-[10px] text-[15px] font-semibold text-slate-100 border border-white/[0.12] hover:bg-white/[0.05] hover:border-white/20 transition-all no-underline">
            Talk to Sales
          </a>
        </div>
      </div>
